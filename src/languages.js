...
Если вы хотите зарегистрироваться, используйте кнопку "Забронировать билет" снова.`,
    ...
    payment_instructions: `💳 <b>Для завершения регистрации</b>

Нажмите кнопку ниже для оплаты через PayMe.

После оплаты вернитесь в бот и отправьте ID транзакции или скриншот для подтверждения.`,

    payment_pending: `⏳ <b>Ваш платеж на проверке</b>

Пожалуйста, подождите подтверждения.`,

    payment_proof_request: `📝 <b>Подтверждение оплаты</b>
